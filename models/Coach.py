        ...
        for epoch in range(1, self.args.epochs + 1):
            ...
            if test_f1 > btf1:
                torch.save(self.model.model,
                           f"./{self.args.save_model_checkpoint}_{self.args.dataset}/{self.args.modalities}_best_model.pt")
                np.save(os.path.join(os.getcwd(), self.args.save_analysis_path + '_' + self.args.dataset,
            ...
            save_loss_plot_path = os.path.join(os.getcwd(), self.args.save_analysis_path + '_' + self.args.dataset,
