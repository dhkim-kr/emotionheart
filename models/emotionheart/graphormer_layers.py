...
class GraphNodeFeature(nn.Module):
    ...
    def forward(self, batched_data):
        ...
        utterance_order_feature = self.order_encoder(utterance_order)
        speaker_identity_feature = self.speaker_encoder(speaker_identity)
        modality_position_feature = self.modality_encoder(modality_position)
